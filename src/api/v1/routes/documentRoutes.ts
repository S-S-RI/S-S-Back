...
import { addDocument, getAllDocuments, modifyDocument, deleteDocument, addNameFieldToDocuments } from "../controllers/documentController";
...
documentRouter.patch("/name", addNameFieldToDocuments)
